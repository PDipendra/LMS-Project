...
<div class="col-sm">
      <div class="alert" style="box-shadow: 2px 2px 2px 2px grey;" role="alert">
        <form style="margin-top: 20px;margin-bottom: 20px;" method="POST" action="addfaculty.php">
          <div class="form-group row">
            <label for="FacultyName" class="col-sm-2 col-form-label">FACULTY NAME</label>
          <div class="col-sm">
            <input type="text" class="form-control"  placeholder="Enter Faculty Name eg:-BCT" name="faculty_name" required="">
          </div>
        </div>
          <div class="form-group row">
            <div class="col-sm">
